...
describe('folds (reduces) the given list from the left with a function', () => {
    xit('empty list', () => {
        const list1 = new List<number>();
        expect(list1.foldl((acc: number, el: number) => el / acc, 2)).toEqual(
            2
        );
    });
    ...
    xit('division of integers', () => {
        const list1 = new List([1, 2, 3, 4]);
        expect(list1.foldl((acc: number, el: number) => el / acc, 24)).toEqual(
            64
        );
    });
});
...
describe('folds (reduces) the given list from the right with a function', () => {
    xit('empty list', () => {
        const list1 = new List<number>();
        expect(list1.foldr((acc: number, el: number) => el / acc, 2)).toEqual(
            2
        );
    });
    ...
    xit('division of integers', () => {
        const list1 = new List([1, 2, 3, 4]);
        expect(list1.foldr((acc: number, el: number) => el / acc, 24)).toEqual(
            9
        );
    });
});
